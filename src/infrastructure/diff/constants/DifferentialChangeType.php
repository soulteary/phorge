...
/**
 * Constants describing how a version control system changed a path, and what
 * kind of file it is.
 *
 * This is version control vocabulary, not revision vocabulary: Diffusion's
 * browse, history and diff queries, the three commit change parsers and the
 * repository graph cache all speak it. It was filed under the removed
 * Differential application; the name is kept so stored values and callers are
 * unaffected.
 */
